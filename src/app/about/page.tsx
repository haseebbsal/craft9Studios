            ...
            <div className="flex flex-col gap-20">
                <div className="pt-40 px-10 flex gap-4 justify-center">
                    ...
                    <div className="w-[25rem]">
                        <div className="h-[25rem]"><Image className="h-full w-full" src={'/images/about/Founder.png'} alt="founder" width={200} height={200} /></div>
                ...
                <div className="flex gap-2 flex-wrap p-2 justify-center">
                    <div className="h-[20rem] w-[18rem]">
                        <Image className="h-full w-full" src={'/images/about/team-1.png'} alt="team member 1" width={200} height={200}/>
                    </div>
                    <div className="h-[20rem] w-[18rem]">
                        <Image className="h-full w-full" src={'/images/about/team-2.png'} alt="team member 1" width={200} height={200} />
                    </div>
                    <div className="h-[20rem] w-[18rem]">
                        <Image className="h-full w-full" src={'/images/about/team-3.png'} alt="team member 1" width={200} height={200} />
                    </div>
                    <div className="h-[20rem] w-[18rem]">
                        <Image className="h-full w-full" src={'/images/about/team-4.png'} alt="team member 1" width={200} height={200} />
                    </div>
                </div>    
            </div>
        </>
