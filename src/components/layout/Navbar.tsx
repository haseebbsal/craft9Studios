...
export default function Navbar() {
    ...
    return (
        <div className="bg-black p-4 fixed flex justify-center z-[33333333333333] w-[100vw]">
                ...
                <div className="flex gap-4 sm:gap-8">
                    <div className="relative">
                        ...
                        <div className={`${dropOption=='1'?'flex':'hidden'} flex-col absolute gap-2 bg-[#282828] p-4 top-[2.5rem] rounded-md `}>
                            ...
                            <Link className="text-sm" href={'/productions'}>productions</Link>
                            <Link className="text-sm" href={'/strategies'}>strategies</Link>
                        </div>
                    </div>
